...
public class MawaSyncManager {
        ...
        try {
            ...
            if (response.isSuccessful() && response.body() != null) {
                ...
                if (arr != null && arr.size() > 0) {
                    ...
                    if (latestBackup.has("data")) {
                        JsonObject cloudData = latestBackup.getAsJsonObject("data");
    ...
    private boolean pushUserBackup(String url, String apikey, String token, String userId) {
        try {
            ...
            row.addProperty("backup_name", "MAWA_AUTO_BACKUP_" + System.currentTimeMillis());
            row.add("data", backupData);
